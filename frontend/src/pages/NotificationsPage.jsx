...
function NotificationsPage() {
  ...
  const {mutate:acceptRequestMutation,isError,isPending}=useMutation({
    ...
    <div className='p-4 sm:p-6 lg:p-8'>
      ...
      {isLoading?(
        ...
        {incomingRequests.length===0 && (
          <div><h2 className='text-xl font-semibold'>YOU DO NOT HAVE ANY PENDING FRIEND REQUESTS</h2></div>
        )}
        {incomingRequests.length>0 &&(
